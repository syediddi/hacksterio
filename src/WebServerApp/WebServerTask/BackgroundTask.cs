...
namespace WebServerTask
{
    ...
    {
        string HtmlString = "<html><head><title>Blinky App</title></head><body><form action=\"blinky.html\" method=\"GET\"><input type=\"radio\" name=\"relay1\" value=\"on\" onclick=\"this.form.submit()\"> Fan On<hr><input type=\"radio\" name=\"relay1\" value=\"off\" onclick=\"this.form.submit()\"> Fan Off <hr><input type=\"radio\" name=\"relay2\" value=\"on\" onclick=\"this.form.submit()\"> Light On<hr><input type=\"radio\" name=\"relay2\" value=\"off\" onclick=\"this.form.submit()\"> Light Off</form></body></html>";
        //string onHtmlString = "<html><head><title>Blinky App</title></head><body><form action=\"blinky.html\" method=\"GET\"><input type=\"radio\" name=\"state\" value=\"on\" checked onclick=\"this.form.submit()\"> Light On<br><input type=\"radio\" name=\"state\" value=\"off\" onclick=\"this.form.submit()\"> Light Off<input type=\"radio\" name=\"state2\" value=\"on\" onclick=\"this.form.submit()\"> Fan On<br><input type=\"radio\" name=\"state2\" value=\"off\" checked onclick=\"this.form.submit()\"> Fan Off</form></body></html>";
